...
- **Frontend (React):** the interactive product browsing UI, which is what actually captures the signals (what a user looks at, what they say they want) that feed the backend.
